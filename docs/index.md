...
- Authors: learn the [language](language_guide.md), [pattern systems](pattern_systems.md), [community packages](community_patterns.md), [domain modules](domain_modules.md), and [visual editor](editor_guide.md).
