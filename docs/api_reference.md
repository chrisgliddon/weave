...
| `weave-character` | `CharacterProfile`, all HEXACO factors/facets, derived OCEAN views, versioned extensions, templates/overlays/synthesis, deterministic collections, scoped operation requests, resumable proposals, whole reviews, atomic apply, `character_module_manifest`, `character_domain_pack`, and schemas | [Open rustdoc](api/weave_character/index.html) |
