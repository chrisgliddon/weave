...
| `weave-character` | `CharacterProfile`, all HEXACO factors/facets, derived OCEAN views, versioned extensions, typed operations/diagnostics, templates, overlays, synthesis, and schemas | [Open rustdoc](api/weave_character/index.html) |
