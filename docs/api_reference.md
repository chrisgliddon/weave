...
| `weave-character` | `CharacterProfile`, all HEXACO factors/facets, derived OCEAN views, templates/overlays/synthesis, guided workspaces/revisions/previews, original questionnaire packs and reviewed receipts, final review summaries, deterministic collections, alignment/date-context receipts, `character_module_manifest`, `character_domain_pack`, and schemas | [Open rustdoc](api/weave_character/index.html) |
