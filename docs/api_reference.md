...
| `weave-character` | `CharacterProfile`, all HEXACO factors/facets, derived OCEAN views, templates/overlays/synthesis, guided authoring, immutable relationship-kind packs, layered graph revisions/proposals/reviews/receipts/reconciliation, deterministic collections, alignment/date-context receipts, `character_module_manifest`, `character_domain_pack`, and schemas | [Open rustdoc](api/weave_character/index.html) |
